...
export interface Page {
  ...
  title: string;
  hero: {
    type: 'none' | 'highImpact' | 'mediumImpact' | 'lowImpact' | 'leadCapture';
    /**
     * Short trust line shown above the headline, e.g. "Trusted by Richmond Homeowners".
     */
  ...
  localSeo?: {
     ...
     */
    enableLocalBusinessSchema?: boolean | null;
    /**
...
export interface TestimonialsBlock {
  ...
  items?:
    | {
        ...
        authorName: string;
        /**
         * e.g. "Church Hill, Richmond VA" — local proof matters for both trust and SEO.
         */
...
export interface QuoteBannerBlock {
  ...
  authorName: string;
  rating?: number | null;
  colorway?: ('primary' | 'secondary' | 'accent' | 'neutral') | null;
  id?: string | null;
  blockName?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AreaServedBlock".
 */
export interface AreaServedBlock {
  eyebrow?: string | null;
  heading: string;
  body: string;
  id?: string | null;
  blockName?: string | null;
  blockType: 'areaServed';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Location {
  id: number;
  /**
   * e.g. "Hopewell" — used throughout the page copy.
   */
  cityName: string;
  stateAbbr: string;
  /**
   * e.g. "We Buy Houses for Cash in the City of Hopewell, VA"
   */
  heroHeadline: string;
  /**
   * Reuse the site-wide "Get Your Cash Offer" form unless this location needs its own.
   */
  form?: (number | null) | Form;
  /**
  ...
  checklistGroups?:
    ...
    | null;
  /**
   * e.g. "Get A Fast And Fair Cash Offer On Your House In Hopewell"
   */
  ...
  localSeo?: {
    enableLocalBusinessSchema?: boolean | null;
    /**
     * Leave empty to use the business-wide default.
     */
    schemaAreaServed?:
      | {
          name: string;
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        areaServed?: T | AreaServedBlockSelect<T>;
        statRow?: T | StatRowBlockSelect<T>;
      };
  localSeo?:
    | T
    | {
        enableLocalBusinessSchema?: T;
        schemaAreaServed?:
          | T
          | {
              name?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AreaServedBlock_select".
 */
export interface AreaServedBlockSelect<T extends boolean = true> {
  eyebrow?: T;
  heading?: T;
  body?: T;
  id?: T;
...
export interface Business {
  ...
  /**
   * Optional — omit if you operate without a public office address.
   */
  ...
  areaServed?:
    ...
    | null;
  /**
   * Google Business Profile, Facebook, BBB, etc. — feeds the sameAs schema property.
   */
  sameAs?:
    | {
        url: string;
